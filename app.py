...
def plot():
    ...
    # Utilisation d'un graphique en bâtonnets
    fig = px.bar(df, x='Habit', color='Status', barmode='group', title='Statut des Habitudes')
    fig.update_layout(xaxis_title='Habitude', yaxis_title='Nombre', legend_title='Statut')
